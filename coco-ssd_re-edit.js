 ...
 * 2023/11/16(Thu)
 * Editor:      Shim(NPCshim)
 * Description: Added identification (ident) in addition to bbox, class, and score from the COCO-SSD model.
 * Specifics:   I added "ident" as a variable in order to make out what kind of object is detected.
 * 
 * 編集者: Shim(NPCshim)
 * 概要:   COCO-SSDモデルからbbox、class、scoreのほかにidentification(ident)を追加。
 * 詳細:   どの種類のオブジェクトが検出されているか判別するため、identを変数として追加した。
 * /
